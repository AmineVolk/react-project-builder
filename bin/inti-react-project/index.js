...
program
  ...
  .action(async (arg, options) => {
    if (checkInitProjectOptions(options)) {
      ...
      shell
        .ShellString(navBar.content)
        .to("src/app/components/navBar/index.jsx");

      //create simple footer
      shell.mkdir("src/app/components/footer");
      shell
        .ShellString(footer.content)
        .to("src/app/components/footer/index.jsx");
      ...
      shell
        .ShellString(JSON.stringify({ isUseRedux }))
