...
module.exports.createInitialScreens = isUseRedux => {
  ...
  if (isUseRedux) {
    shell
      .ShellString(getScreenContainerExp("home"))
      .to("src/app/screens/home/homeContainer.js");
    shell
      .ShellString(getScreenContainerExp("screenExp1"))
      .to("src/app/screens/screenExp1/screenExp1Container.js");
  }
};
